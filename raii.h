#ifndef __ONDRA_SHARED_RAII_5146848941361
#define __ONDRA_SHARED_RAII_5146848941361
...
template<typename Res, typename FnType, FnType fn>
void swap(ondra_shared::RAII<Res,FnType,fn> &a, ondra_shared::RAII<Res,FnType,fn> &b) {
     a.swap(b);
}
